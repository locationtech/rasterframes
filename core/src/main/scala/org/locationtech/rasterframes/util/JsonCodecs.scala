 ...
 */
// Copied from GeoTrellis 2.3 during conversion to 3.0
...
trait JsonCodecs {
  ...
  implicit object GridBoundsFormat extends RootJsonFormat[GridBounds[Int]] {
  ...
  implicit object SchemaFormat extends RootJsonFormat[Schema] {
    ...
    def write(obj: Schema) = enrichString(obj.toString).parseJson
  }
