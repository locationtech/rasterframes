...
class TestEnvironment(unittest.TestCase):
    ...
    def l8band_uri(cls, band_index):
        return "file://" + os.path.join(
            cls.resource_dir, "L8-B{}-Elkton-VA.tiff".format(band_index)
        )
    ...
    def create_layer(self):
        ...
        rf = self.spark.read.geotiff(self.img_uri).with_bounds().with_center()
        ...
        self.df = self.prdf.withColumn("tile", rf_convert_cell_type("proj_raster", "float32")).drop(
            "proj_raster"
        )
