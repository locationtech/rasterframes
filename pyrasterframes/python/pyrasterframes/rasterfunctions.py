...
_rf_column_functions = {
    ...
    'exists': 'Returns true if any cells in the tile are true (non-zero and not nodata)',
    'any': 'Returns true if any cells in the tile are true (non-zero and not nodata)',
    'for_all': 'Returns true if all cells in the tile are true (non-zero and not nodata)',
